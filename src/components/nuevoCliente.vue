            ...
            <v-row>
              ...
              <v-col cols="12">
                <v-text-field
                  ...
                  required
                  variant="outlined"
                  v-model="formCliente.direccionResidencia"
              ...
              <v-col md="6" cols="12">
                <v-autocomplete
                  ...
                  variant="outlined"
                  v-model="formCliente.venta.producto"
                  :rules="campoRules"
                ></v-autocomplete>
              </v-col>
              <v-col md="6" cols="12">
                <v-text-field
                  ...
                  min="1"
                  variant="outlined"
                  v-model="formCliente.venta.cantidad"
                  :rules="cantidadRules"
                ></v-text-field>
              </v-col>
              <v-col cols="6">
              ...
              <v-col cols="6" v-if="formaPago == 2">
                <v-text-field
                  ...
                  min="1"
                  variant="outlined"
                  v-model="formCliente.venta.cuotas"
                  :rules="cantidadRules"
                ></v-text-field>
              </v-col>
              ...
              <v-col cols="12" v-if="formaPago == 2">
                <VueDatePicker
                  ...
                  v-model="formCliente.venta.pago_fechas"
                  multi-dates
                  :min-date="new Date()"
