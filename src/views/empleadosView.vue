                    ...
                    <v-card-text>
                        <v-container>
                            <v-form ref="formEmpleado">
                                <v-row>
                                    <v-col cols="12">
                                        <v-text-field label="Nombre empleado" type="text" required
                                            variant="outlined" v-model="formEmpleado.nombre" :rules="nombreRules"
                                            :counter="65"></v-text-field>
                                    </v-col>
                                    <v-col cols="12">
                                        <v-select label="Rol" :items="roles" required
                                            variant="outlined" v-model="formEmpleado.rol"
                                            :rules="[v => !!v || 'El rol es requerido']"></v-select>
                                    </v-col>
                                    <v-col cols="12" sm="6">
                                        <v-text-field type="text" variant="outlined" label="Usuario" required
                                            v-model="formEmpleado.usuario"
                    ...
                    <v-container>
                        <v-form ref="formEmpleadoEditar">
                            <v-row>
                                <v-col cols="12">
                                    <v-text-field label="Nombre empleado" type="text" required
                                        variant="outlined" v-model="paqueteEditar.nombre" :rules="nombreRules"
                                        :counter="65"></v-text-field>
                                </v-col>
                                <v-col cols="12">
                                    <v-select label="Rol" :items="roles" required
                                        variant="outlined" v-model="paqueteEditar.rol"
                                        :rules="[v => !!v || 'El rol es requerido']"></v-select>
                                </v-col>
                                <v-col cols="12" sm="6">
                                    <v-text-field type="text" persistent-hint hint="No modificar para no cambiar el usuario" variant="outlined" label="Usuario"
                                        v-model="paqueteEditar.usuario"
                                        :rules="usuarioRules"></v-text-field>
                                </v-col>
                                <v-col cols="12" sm="6">
                                    <v-text-field label="Contraseña" persistent-hint hint="No modificar para no cambiar la contraseña" v-model="paqueteEditar.contrasena"
                                        :append-inner-icon="visibleContra ? 'mdi-eye-off' : 'mdi-eye'"
                                        :type="visibleContra ? 'text' : 'password'"
                                        variant="outlined"
                                        @click:append-inner="visibleContra = !visibleContra"></v-text-field>
